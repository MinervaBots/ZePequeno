...
void loop() {
  ...
  if (btn_state) {
    ...
    if (digitalReadFast(SWITCH_FOUR) + digitalReadFast(SWITCH_THREE) * 2 +  digitalReadFast(SWITCH_TWO) * 4 + digitalReadFast(SWITCH_ONE) * 8 == 0) {
      seekAndDestroy(false);
    } else if (digitalReadFast(SWITCH_FOUR) + digitalReadFast(SWITCH_THREE) * 2 +  digitalReadFast(SWITCH_TWO) * 4 + digitalReadFast(SWITCH_ONE) * 8 == 1) {
